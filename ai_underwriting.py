...
def build_rent_ai_prompt_text() -> str:
    return (
        ...
        "the component is supported by listing facts or clearly labeled low-confidence reasoning. If your reasoning "
        "mentions a separate suite, cottage, carriage house, garden suite, or other rentable unit, rent_components "
        "must include that unit plus the main unit, and the component rents should approximately add up to "
        "suggested_rent_monthly. Do not treat ensuite bathrooms, guest rooms, dens, or generic bedroom/bathroom "
        "counts as rentable suite components unless the listing clearly describes a separate rentable unit with "
        "its own living facilities or separate occupancy potential.\n\n"
